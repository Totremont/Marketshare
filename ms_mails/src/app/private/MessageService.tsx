import SpecialColors from "./Colors";
  ...
  args.details.forEach((it, index) => 
    {
      ...
      if(index < args.details.length - 1) //Si no es el último elemento
        ...
        styleDetails = styleDetails.concat(`${it.data}: <span style="font-weight: 600; color: ${SpecialColors.YELLOW}">${it.value}</span><br />`)
    })
  ...
  args.details.forEach((it, index) => 
    {
      ...
      if(index < args.details.length - 1) //Si no es el último elemento
        ...
        styleDetails = styleDetails.concat(`${it.data}: <span style="font-weight: 600; color: ${SpecialColors.GREEN}">${it.value}</span><br />`)
    })
  ...
  args.details.forEach((it, index) => 
    {
      ...
      if(index < args.details.length - 1) //Si no es el último elemento
        ...
        styleDetails = styleDetails.concat(`${it.data}: <span style="font-weight: 600; color: ${SpecialColors.RED}">${it.value}</span><br />`)
    })
